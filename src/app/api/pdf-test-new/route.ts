...
// No metadata exports
// No runtime exports
// Only minimal dynamic export
export const dynamic = 'force-dynamic';

export async function GET() {
  console.log('GET request received on pdf-test-new endpoint');
  return NextResponse.json({ message: 'PDF test new endpoint is working' });
}

export async function POST(request: NextRequest) {
  console.log('POST request received on pdf-test-new endpoint');
